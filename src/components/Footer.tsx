  ...
  return (
    <footer className="bg-[#fff]">
      <div className="container px-4 pt-16 pb-8">
        <div className="grid grid-cols-2 md:grid-cols-[30%_20%_20%_30%] gap-x-4 gap-y-8 mb-8">
          {/* Brand */}
          <div className="space-y-4 col-span-2 md:col-span-1 footer-col1">
            <div>
              <img src={logo} alt="PulseBoard" className=" w-full px-8 mb-4" />
              <p className="px-8 text-center">The Go-To Platform for<br></br> Building Stronger Teams </p>
            </div>
          </div>
      ...
      <div className="footer-rights py-3">
        <div className="container px-4">
          <p className="text-center text-black text-sm">
            © 2026 Caregiver Onboarding. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
